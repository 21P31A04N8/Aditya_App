                   ...
                   Positioned(
                     ...
                     child: GestureDetector(
                       onTap: (){
                         ...
                         check1 = ! check1;
                         (check1) ? _animationController2!.forward() : _animationController2!.reset();
                   ...
                   Positioned(
                     ...
                     child: InkWell(
                       onTap: (){
                         ...
                         _animationController8!.reset();
                         check2 = ! check2;
                         (check2) ? _animationController3!.forward() : _animationController3!.reset();
                   ...
                   Positioned(
                     ...
                     child: InkWell(
                       onTap: (){
                         ...
                         _animationController8!.reset();
                         check3 = ! check3;
                         (check3) ? _animationController4!.forward() : _animationController4!.reset();
                      ...
                      Positioned(
                        ...
                        child: InkWell(
                          onTap: (){
                            ...
                            _animationController8!.reset();
                            check4 = ! check4;
                            (check4) ? _animationController5!.forward() : _animationController5!.reset();
                          },
                          child: Transform(
                      ...
                      Positioned(
                        ...
                        child: GestureDetector(
                          onTap: (){
                            ...
                            _animationController8!.reset();
                            check5 = ! check5;
                         (check5) ? _animationController6!.forward() : _animationController6!.reset();
                      ...
                      Positioned(
                        ...
                        child: InkWell(
                          onTap: (){
                            ...
                            _animationController8!.reset();
                            check6  = ! check6;
                         (check6) ? _animationController7!.forward() : _animationController7!.reset();
