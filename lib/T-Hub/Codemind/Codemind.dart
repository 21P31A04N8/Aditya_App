          ...
          children: [
            ...
            Padding(
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    Text('Codemind',style: TextStyle(fontSize: 30,fontWeight: FontWeight.bold),),
                    Padding(
                      padding: const EdgeInsets.symmetric(horizontal: 20,vertical: 5),
                      child: Text("Code Mind is a platform that focuses on crafting a skilled individual. Our unique and interactive secenario based learning modules are designed to help a student look at a problem in a life like perspective. We stongly believe that every mind isn't alike, and therefore we give the student a chace to express their opinion rather than trying to abide by a generalized one.",style: TextStyle(fontSize: 16,color: Colors.white),textAlign: TextAlign.justify,),
                    )
                  ],
                )
                                ...
                                child: Row(
                                  children: [
                                    (index % 2 == 0)
                                        ...
                                        : Container(height: 19.h,width:70.w,
                                      decoration: BoxDecoration(
                                          color: Colors.blue[100],
