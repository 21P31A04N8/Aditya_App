                    ...
                    child: SizedBox(
                      ...
                      child: Column(
                        children: [
                          ...
                          Lottie.asset(
                              controller: home,
                              fit:BoxFit.fill, "assets/Thub/lotties/HOME.json"),
                          // Image.asset('assets/Thub/lotties/MECH.jpg'),
                          Container(
                            height: 3,
                            width: 20,
                            decoration: BoxDecoration(
                                color:  (selectedIndex == 0) ? Colors.greenAccent : Colors.transparent,
                                borderRadius: BorderRadius.circular(360)
                            ),
                          ),
                    ...
                    child: SizedBox(
                      ...
                      child: Column(
                        children: [
                          ...
                          Lottie.asset(
                              controller: events,
                              fit:BoxFit.cover , "assets/Thub/lotties/EVENTS.json"),
                          Container(
                            height: 3,
                            width: 20,
                            decoration: BoxDecoration(
                    ...
                    child: SizedBox(
                      ...
                      child: Column(
                        children: [
                          ...
                          Lottie.asset(
                              controller: certify,fit:BoxFit.cover,
                              height: 40,width:35,
                    ...
                    child: SizedBox(
                      ...
                      child: Column(
                        children: [
                          ...
                          Lottie.asset(
                              controller: call,
                              fit:BoxFit.cover , "assets/Thub/lotties/TEAM.json"),
                          SizedBox(height:7),
                          Container(
                            height: 3,
                            width: 20,
                    ...
                    child: SizedBox(
                      ...
                      child: Column(
                        children: [
                          ...
                          Lottie.asset(
                              controller: team,
                              fit:BoxFit.cover , "assets/Thub/lotties/CALL.json"),
